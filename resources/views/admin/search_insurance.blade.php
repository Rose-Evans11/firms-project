      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-lg-2">
              <div class="form-group">
                <a href="<?= url('firms/admin/dashboard'); ?>" style="width:100%; text-decoration:none">View All</a>
              </div>
            </div>
            <div class="col-lg-2">
              <div class="form-group">
            ...
            <div class="col-lg-2">
              <div class="form-group">
                <a type="submit" class="btn btn-success" style="width:100%; margin-top:5px" href="{{route('insurance.find.pdf', ['insurance'=>$insurance->query])}}">PDF</a>
              </div>
            </div>
            <div class="col-lg-2">
              <div class="form-group">
