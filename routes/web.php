...
Route::get('/indemnity/pdf/', [generateAdminReportController::class, 'createPDFIndemnity'])->name('indemnity.pdf');
...
Route::get('/indemnity/excel/', [generateAdminReportController::class, 'createExcelIndemnity'])->name('indemnity.excel');
...
Route::get('/indemnity/csv/', [generateAdminReportController::class, 'exportCsvIndemnity'])->name('indemnity.csv');
