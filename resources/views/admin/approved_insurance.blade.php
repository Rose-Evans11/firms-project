        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
              ...
              <tr>
               ...
               <td><a href="{{route('admin.insurance.edit', ['insurances'=>$insurance->id])}}" style="width:100%; text-decoration:none;white-space: nowrap; "> Edit</a></td>
               <td><a href="{{route('admin.insurance.view', ['insurances'=>$insurance->id])}}" style="width:100%; text-decoration:none;white-space: nowrap; "> View</a></td>
              </tr>
              @endforeach
              @else
