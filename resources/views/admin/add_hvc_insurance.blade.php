...
@section('title','High Value Crop Insurance')
@section('content')
<head>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="farmersID" class="col-lg-12 control-label">Farmer's ID: </label>
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="farmersID" @required(true) name="farmersID">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text"  class="form-control" id="rsbsa" @@required(true) name="rsbsa">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="txt_fname" placeholder="First Name" name="firstName" @required(true)>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="txt_mname"  placeholder="Middle Name" name="middleName">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="txt_lname" placeholder="Last Name" name="lastName" @required(true)>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="txt_extname" placeholder="Extension Name" name="extensionName">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="date" class="form-control" id="dt_birth" name="birthdate" @required(true)>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="txt_spouse" name="spouseName" @required(true)>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="email" class="form-control" id="txt_email"  name="email" @required(true)>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="tel" class="form-control" id="txt_tel"  name="contactNumber" @required(true)>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-12">
                          <input type="text" class="form-control" id="ip_tribe" placeholder="Tribe" name="indigenous">
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div id="bankInfo" class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="number" class="form-control" id="txt_acc_num" name="bankAccount" @required(true)>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="text" class="form-control" id="txt_bank_name" name="bankName" @required(true)>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="text" class="form-control" id="txt_bank_branch" name="bankBranch" @required(true)>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="text" @readonly(true) class="form-control" id="insuranceType" value="High-Value Crops" name="insuranceType">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <select class="form-select" aria-label="Default select example" name="cropName">
                    <option value="Alukbati">Alukbati</option>
                    ...
                    <option value="Sili Labuyo">Sili Labuyo</option>
                    <option value="Sili Sigang">Sili Sigang</option>
                    <option value="Sili Talbos"> Sili Talbos</option>
