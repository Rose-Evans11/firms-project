...
<div class='container-fluid' style="margin: auto">
  <form class="form-horizontal">
    <fieldset>
      ...
      <!-- Reviewing Farmer's Info -->
       <div class="m-5" id='farmInfo'>
        <div>
      ...
      <!-- Reviewing Legal Beneficiaries details -->
      <div id="benefiInfo">
        <div >
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-lg-6 col-lg-offset-2 mt-2">
              <button type="submit" class="btn btn-success" id='btnFarms' onclick="javascript:displayBenefits()"> Farmer's Information</button>
            </div>
            <div class="col-lg-6 col-lg-offset-2 mt-2">
              <button type="submit" class="btn btn-success" id='btnBenefits' onclick="javascript:displayBenefits()"> Benefits</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    var benefiInfo = document.getElementById("benefiInfo");
    var farmInfo = document.getElementById("farmInfo");
    var btnFarms = document.getElementById("btnFarms");
    var btnBenefits = document.getElementById("btnBenefits");
    
    //this is to display benefits card
    function displayBenefits()
    {
      farmInfo.style.visibility = "hidden";
      benefiInfo.style.visibility = "visible";
    }

    window.onload = function() {
      farmInfo.style.visibility = "visible";
      btnFarms.style.visibility = "visible";
      btnBenefits.style.visibility = "visible";
      benefiInfo.style.visibility = "hidden";
  };
  </script>
