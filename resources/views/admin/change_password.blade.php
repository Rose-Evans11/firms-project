...
<div class='container-fluid' style="margin: auto">
    <div class="row d-flex justify-content-center">
      ...
      @endphp
      @endif
           <form method="POST" action="{{ route('admin.updatePassword'),  Auth::guard('admin')->user()->id  }}">
            @csrf
            <div class="col-md-12">
                <label for="current_password" class="col-lg-12 control-label">Old Password:</label>
                <div class="col-lg-12">
                  <input type="password" class="form-control" id="current_password" name="current_password" required autocomplete="new-password">
                </div>
              </div>
            <div class="col-md-12">
