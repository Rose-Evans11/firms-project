      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
                <a href="<?= url('firms/admin/dashboard'); ?>" style="width:100%; text-decoration:none;  margin-top:5px" class="btn btn-success">View All</a>
              </div>
            </div>
            <div class="col-lg-2">
              <div class="form-group">
            ...
            <div class="col-lg-2">
              <div class="form-group">
                <a type="submit" class="btn btn-success" style="width:100%; margin-top:5px" href="{{URL::to('/insurance/find/pdf/')}}">PDF</a>
              </div>
            </div>
            <div class="col-lg-2">
              <div class="form-group">
