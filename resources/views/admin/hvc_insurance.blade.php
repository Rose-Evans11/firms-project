...
<div class='container-fluid' style="margin: auto">
  ...
  @endif
  <form action="{{ route('admin.insurance.hvc.find') }}" method="GET"> 
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="col-md-6 mx-3">
          <div class="col-lg-12">
            <a href="<?= url('firms/admin/add/hvc-insurance'); ?>" style="text-decoration: none; color:white" class="btn btn-success">Add High Value Crop Insurance</a>
          </div>
        </div>
      </div>
    </div>
