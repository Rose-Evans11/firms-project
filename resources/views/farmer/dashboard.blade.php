        ...
        <div class="col-md-2">
            <div class="card text-white mb-3" style="background-color:#6CA26D; max-height: 125px">
                <div class="card-body">
                  ...
                  <p class="card-text fs-1 text-center fw-bolder">{{DB::table('insurances')->where('farmersID', auth()->id())->where('status', 'Rejected')->where('status', 'Partially Rejected')->get()->count()}}</p>
                </div>
            </div>
        </div>
        <div class="col-md-2">
