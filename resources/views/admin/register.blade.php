                ...
                <tbody>
                    @if(count($users) > 0)
                        ...
                        <tr>
                            ...
                            <td>
                              <img src="{{('valid_id_image_location/' . $user->validIDPhoto)}}" alt="Valid ID Photo" style="width:150px; height:auto">
                            </td>
                            <td>                              
                              <img src="{{('profile_image_location/' . $user->photo)}}" alt="Photo" style="width:150px; height:auto">
                            </td>
                            <td>{{$user->isActive}}</td>
